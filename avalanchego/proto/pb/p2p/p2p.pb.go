...
// ref. https://pkg.go.dev/github.com/tenderly/net-flare/avalanchego/network#Network "Dispatch"
type Version struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
// ref. https://pkg.go.dev/github.com/tenderly/net-flare/avalanchego/utils/ips#ClaimedIPPort
