...
go build $build_args -modcacherw -ldflags "-X github.com/tenderly/net-flare/avalanchego/version.GitCommit=$git_commit $static_ld_flags" -o "$avalanchego_path" "$AVALANCHE_PATH/main/"*.go
