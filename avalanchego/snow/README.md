...
### [Outbound Messages](https://github.com/tenderly/net-flare/avalanchego/blob/master/message/outbound_msg_builder.go)
...
### [Network](https://github.com/tenderly/net-flare/avalanchego/blob/master/network/network.go)
...
## [Router](https://github.com/tenderly/net-flare/avalanchego/blob/master/snow/networking/router/chain_router.go)
...
## [Handler](https://github.com/tenderly/net-flare/avalanchego/blob/master/snow/networking/handler/handler.go)
...
## [Sender](https://github.com/tenderly/net-flare/avalanchego/blob/master/snow/networking/sender/sender.go)
...
## [Consensus Engine](https://github.com/tenderly/net-flare/avalanchego/blob/master/snow/consensus/snowman/consensus.go)
...
## [Blockchain Creation](https://github.com/tenderly/net-flare/avalanchego/blob/master/chains/manager.go)
