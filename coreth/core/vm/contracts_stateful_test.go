...
func TestStatefulPrecompile(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			evm := NewEVM(vmCtx, TxContext{}, stateDB, params.TestFlareApricotPhase5Config, Config{}) // Use ApricotPhase5Config because these precompiles are deprecated in ApricotPhase6.
