...
import (
	...
	"github.com/tenderly/net-flare/coreth/accounts/keystore"
	...
	"github.com/tenderly/net-flare/coreth/core/bloombits"
	...
	"github.com/tenderly/net-flare/coreth/internal/blocktest"
...
func TestRPCMarshalBlock(t *testing.T) {
	...
	for i, tc := range testSuite {
		resp := RPCMarshalBlock(block, tc.inclTx, tc.fullTx, params.TestFlareChainConfig)
...
func setupReceiptBackend(t *testing.T, genBlocks int) (*testBackend, []common.Hash) {
	...
	var (
		...
		signer   = types.LatestSignerForChainID(params.TestFlareChainConfig.ChainID)
