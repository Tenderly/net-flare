...
import (
	...
	"github.com/tenderly/net-flare/coreth/precompile"
...
func (c *ChainConfig) String() string {
	...
	banner += fmt.Sprintf(" - Apricot Phase 1 Timestamp:        %-8v (https://github.com/tenderly/net-flare/avalanchego/releases/tag/v1.3.0)\n", c.ApricotPhase1BlockTimestamp)
	banner += fmt.Sprintf(" - Apricot Phase 2 Timestamp:        %-8v (https://github.com/tenderly/net-flare/avalanchego/releases/tag/v1.4.0)\n", c.ApricotPhase2BlockTimestamp)
	banner += fmt.Sprintf(" - Apricot Phase 3 Timestamp:        %-8v (https://github.com/tenderly/net-flare/avalanchego/releases/tag/v1.5.0)\n", c.ApricotPhase3BlockTimestamp)
	banner += fmt.Sprintf(" - Apricot Phase 4 Timestamp:        %-8v (https://github.com/tenderly/net-flare/avalanchego/releases/tag/v1.6.0)\n", c.ApricotPhase4BlockTimestamp)
	banner += fmt.Sprintf(" - Apricot Phase 5 Timestamp:        %-8v (https://github.com/tenderly/net-flare/avalanchego/releases/tag/v1.7.0)\n", c.ApricotPhase5BlockTimestamp)
	banner += fmt.Sprintf(" - Songbird Transition Timestamp:    %-8v\n", c.SongbirdTransitionTimestamp)
	banner += fmt.Sprintf(" - Apricot Phase P6 Timestamp        %-8v (https://github.com/tenderly/net-flare/avalanchego/releases/tag/v1.8.0)\n", c.ApricotPhasePre6BlockTimestamp)
	banner += fmt.Sprintf(" - Apricot Phase 6 Timestamp:        %-8v (https://github.com/tenderly/net-flare/avalanchego/releases/tag/v1.8.0)\n", c.ApricotPhase6BlockTimestamp)
	banner += fmt.Sprintf(" - Apricot Phase Post-6 Timestamp:   %-8v (https://github.com/tenderly/net-flare/avalanchego/releases/tag/v1.8.0\n", c.ApricotPhasePost6BlockTimestamp)
	banner += fmt.Sprintf(" - Banff Timestamp:                  %-8v (https://github.com/tenderly/net-flare/avalanchego/releases/tag/v1.9.0)\n", c.BanffBlockTimestamp)
	banner += fmt.Sprintf(" - Cortina Timestamp:                %-8v (https://github.com/tenderly/net-flare/avalanchego/releases/tag/v1.10.0)\n", c.CortinaBlockTimestamp)
	banner += fmt.Sprintf(" - DUpgrade Timestamp               %-8v (https://github.com/tenderly/net-flare/avalanchego/releases/tag/v1.11.0)\n", c.DUpgradeBlockTimestamp)
	banner += "\n"
	return banner
}
