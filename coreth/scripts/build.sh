...
go build -modcacherw -ldflags "-X github.com/tenderly/net-flare/coreth/plugin/evm.GitCommit=$coreth_commit -X github.com/tenderly/net-flare/coreth/plugin/evm.Version=$coreth_version" -o "$binary_path" "plugin/"*.go
